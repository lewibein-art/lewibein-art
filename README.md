...
Перехожу в дата-аналитику из фармацевтики осознанно и с удовольствием. 6 лет работы с данными в лабораториях научили меня искать аномалии и проверять гипотезы. Теперь применяю эти навыки в IT.

## 🔍 Чем занимаюсь сейчас

- ✅ Прошла переобучение на аналитика данных в **Яндекс.Практикуме** (2026)
- 📊 Делаю пет-проекты: продуктовая аналитика, SQL-запросы, дашборды в BI
- 🎯 Ищу позицию **Junior Data Analyst** или стажировку

## 🛠 Стек

**Языки и БД:** Python, SQL, PostgreSQL  
...
💡 **Моя суперсила:** умею переводить сложные данные в понятные бизнес-рекомендации.
